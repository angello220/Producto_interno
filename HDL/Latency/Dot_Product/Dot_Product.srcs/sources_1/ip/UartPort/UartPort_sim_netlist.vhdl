...
architecture STRUCTURE of UartPort_uart_baud_tick_gen is
  ...
  signal \NLW_acc_reg[18]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_acc_reg[18]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
...
\acc[12]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\acc[4]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\acc_reg[18]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(1) => p_1_in(18),
      CO(0) => \NLW_acc_reg[18]_i_1_CO_UNCONNECTED\(0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_acc_reg[18]_i_1_O_UNCONNECTED\(3 downto 1),
      O(0) => p_1_in(17),
      S(3 downto 1) => B"001",
      S(0) => acc(17)
    );
...
architecture STRUCTURE of \UartPort_uart_baud_tick_gen__parameterized0\ is
  ...
  signal \acc_reg[18]_i_2_n_2\ : STD_LOGIC;
  signal \acc_reg[18]_i_2_n_7\ : STD_LOGIC;
  signal \acc_reg[4]_i_1_n_0\ : STD_LOGIC;
  signal \acc_reg[4]_i_1_n_1\ : STD_LOGIC;
  signal \acc_reg[4]_i_1_n_2\ : STD_LOGIC;
  signal \acc_reg[4]_i_1_n_3\ : STD_LOGIC;
  ...
  signal \NLW_acc_reg[18]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_acc_reg[18]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  attribute KEEP : string;
  attribute KEEP of \acc_reg[0]\ : label is "yes";
  attribute KEEP of \acc_reg[10]\ : label is "yes";
  attribute KEEP of \acc_reg[11]\ : label is "yes";
...
\acc_reg[18]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => ckin,
      CE => '1',
      D => \acc_reg[18]_i_2_n_2\,
      Q => acc(18),
      R => SR(0)
    );
\acc_reg[18]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \acc_reg[16]_i_1_n_0\,
      CO(3 downto 2) => \NLW_acc_reg[18]_i_2_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \acc_reg[18]_i_2_n_2\,
      CO(0) => \NLW_acc_reg[18]_i_2_CO_UNCONNECTED\(0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_acc_reg[18]_i_2_O_UNCONNECTED\(3 downto 1),
      O(0) => \acc_reg[18]_i_2_n_7\,
      S(3 downto 1) => B"001",
      S(0) => acc(17)
    );
...
\acc_reg[2]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
